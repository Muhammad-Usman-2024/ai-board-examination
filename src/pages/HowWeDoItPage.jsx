...
const HowWeDoItPage = () => {
  ...
  return (
    <>
      <div className="relative bg-cover bg-center h-screen flex items-center justify-center bg-[url('./assets/images/Admission.webp')]">
        {/* Overlay */}
        ...
        <div className="relative z-10 text-center max-w-4xl px-4 sm:px-6 md:px-8 lg:px-16 text-main-light">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-3xl font-aeonik leading-relaxed animate-fade-in">
            At the Institute of Public Companies, we take you through an
            organized and strategically planned journey toward mastering the art
            of international success.
          </p>

          <Link to="/admissionform" className="text-decoration-none">
                ...
                {step.faqs.map((faq, faqIndex) => (
                  <div key={faqIndex} className="mb-4">
                    <div
                      ...
                      className="cursor-pointer flex justify-between bg-main-green items-center p-4 text-main-dark font-barlow font-bold text-lg sm:text-xl lg:text-2xl"
                    >
                      {faq.question}
