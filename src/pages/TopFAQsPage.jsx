  ...
  return (
    <div className="bg-main-light min-h-screen py-16 px-6 sm:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl font-aeonik text-text-color mb-12 text-center animate-fade-in">
        ...
        {faqs.map((faq, index) => (
          <div
            key={index}
            className="bg-main-green mb-6 shadow-md hover:shadow-xl rounded-xl transition-all duration-300 animate-fade-in"
          >
            <div
              onClick={() => toggleFaq(index)}
              className="cursor-pointer flex justify-between items-center p-6 sm:p-8 text-main-dark font-barlow font-bold text-lg sm:text-xl lg:text-2xl"
            >
              {faq.question}
