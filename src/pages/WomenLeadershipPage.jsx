...
const WomenLeadershipPage = () => {
  ...
  const faqs = [
    ...
    {
      question:
        "Are there opportunities to collaborate with other women in the program?",
      answer:
  ...
  return (
    <div className="bg-main-light min-h-screen py-16 px-6 sm:px-12 lg:px-20">
      {/* Hero Section */}
      <div className="relative bg-cover hero_image bg-center h-screen flex items-end justify-center bg-[url('./assets/images/Woman_Back.png')]">
        ...
        <div className="relative z-10 text-center max-w-4xl mb-6 px-6 sm:px-12 lg:px-16 text-main-light">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl font-aeonik leading-relaxed animate-fade-in">
      ...
      <div className="max-w-6xl mx-auto mt-16 text-text-color">
        ...
        <p className="text-base sm:text-lg lg:text-xl font-aeonik leading-relaxed mb-8">
          A dedicated initiative designed to equip women with the tools, skills,
          and confidence needed to thrive in public company leadership. Our
          program welcomes women from all backgrounds and experience levels,
          providing specialized training and mentorship to prepare them for
          executive roles and CEO positions.
          <br />
          <br />
          The Women in Leadership Program is structured to support women at
          different stages in their careers. Through a blend of theory, hands-on
          experience, and one-on-one mentorship, participants learn essential
          business strategies, corporate governance, and financial management.
          The curriculum also covers work-life balance, networking, and personal
          brand building to support women as they navigate the unique challenges
