  ...
  return (
    <div className="bg-main-light min-h-screen py-16 px-6 sm:px-12 lg:px-20">
      ...
      <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl font-aeonik leading-relaxed lg:mt-12 mb-8 animate-fade-in-delay">
        ...
        opportunities in emerging, high-growth sectors. This program explores
        business innovation and R&D strategies designed to attract investment
        bankers and secure funding. Participants learn how to develop
        cutting-edge projects with market-ready solutions, positioning them to
        lead and invest in industries that shape the future.
      </p>
      {/* FAQs Section */}
