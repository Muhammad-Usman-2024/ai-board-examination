...
const YoungLeadersPage = () => {
  ...
  return (
    <div className="bg-main-light min-h-screen py-16 px-6 sm:px-12 lg:px-20">
      {/* Hero Section */}
      <div className="relative bg-cover bg-center hero_image h-screen flex items-center justify-center bg-[url('./assets/images/Young_Back.jpg')]">
        ...
        <div className="relative z-10 text-center max-w-4xl px-6 sm:px-12 lg:px-16 text-main-light">
          ...
          <p className="text-lg sm:text-xl lg:text-3xl font-aeonik leading-relaxed animate-fade-in">
