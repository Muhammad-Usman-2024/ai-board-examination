...
const FourthProgram = () => {
  ...
  const faqs = [
    ...
    {
      question:
        "How does this program handle cultural differences in business?",
      answer:
  ...
  return (
    <div className="bg-main-light min-h-screen py-16 px-6 sm:px-12 lg:px-20">
      {/* Hero Section */}
      <div className="relative bg-cover bg-center min-h-screen flex items-center justify-center bg-[url('./assets/images/Accelerator.webp')]">
        {/* Overlay */}
      ...
      <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl font-aeonik leading-relaxed lg:mt-12 mb-8 animate-fade-in-delay">
        The Visionary Accelerator prepares participants for international
        business leadership and global market expansion. This program covers key
        areas such as global business strategy, C Corporation formation, and
        cross-border operations. By exploring the nuances of international
        regulations and cultural understanding, this course empowers leaders to
        grow their businesses globally and establish recognized, ethical brands.
      </p>
