    ...
    <div className="bg-main-light min-h-screen py-16 px-6 sm:px-12 lg:px-20">
      ...
      <div>
        ...
        <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl font-aeonik leading-relaxed lg:mt-12 mb-8 animate-fade-in-delay">
          ...
          Participants learn how to navigate every phase of the business cycle,
          from initial planning to achieve billion-dollar valuations. The
          program empowers aspiring founders to build ethical, impactful public
          companies that thrive in today’s dynamic market.
        </p>
      </div>
      {/* FAQs Section */}
